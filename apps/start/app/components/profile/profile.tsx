...
export function Profile() {
	...
	return (
		<div className="flex flex-col">
			<button
				type="button"
				className="border-x border-b border-gray-200 z-10 rounded-b-[10px]"
			...
			<div className="p-4 -mt-[72px] flex flex-col gap-4">
				<div className="relative">
					<div className="flex justify-between">
						<button
							type="button"
							className="shrink-0 border size-28 border-gray-200 p-1 bg-white z-20 rounded-[12px]"
					...
					<div className="max-h-100 overflow-y-auto pt-2">
						<p className="text-base text-slate-600">
							Hi there, my name is Ivan. I've created this website to showcase
							my front-end skills. Feel free to explore.
						</p>
					</div>
				</div>
			</div>
